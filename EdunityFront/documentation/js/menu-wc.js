...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">edunity-front documentation</a>
                </li>
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-95e425e50e3c5d013ddfb1bcd7d47e39"' : 'data-target="#xs-components-links-module-AppModule-95e425e50e3c5d013ddfb1bcd7d47e39"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-95e425e50e3c5d013ddfb1bcd7d47e39"' :
                                            'id="xs-components-links-module-AppModule-95e425e50e3c5d013ddfb1bcd7d47e39"' }>
                                            <li class="link">
